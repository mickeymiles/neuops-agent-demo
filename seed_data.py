...
MCP_TOOL_SEED = [
    ...
    {"id": "pm_project_read", "name": "项目档案与成本执行", "desc": "查询项目档案（部门/责任人/区域/合同状态/签约额）与预算/成本执行，"
     ...
     "params_schema": [
         {"name": "project_id", "type": "string", "required": False, "desc": "项目ID（=合同编号，如 DFSY1410017C），为空返回前20条及预警分布"},

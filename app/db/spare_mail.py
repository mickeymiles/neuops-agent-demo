...
_TASK_COLS = (
    "task_id", "thread_msg_id", "d_mail_msg_id", "inquiry_body", "from_email",
    "inquiry_to_json", "inquiry_cc_json", "approver_email",
    ...
    "internal_status", "external_status", "shipped_no", "shipped_mail_meta", "shipped_ask_sent",

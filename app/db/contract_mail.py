...
_WRITE_COLS = (
    ...
    "internal_status", "external_status", "shipped_no", "shipped_mail_meta", "shipped_ask_sent", "mail_archive_json",
...
def _ensure_columns(conn) -> None:
    ...
    additions = {
        ...
        "shipped_no": "TEXT DEFAULT ''", "shipped_mail_meta": "TEXT DEFAULT '{}'", "shipped_ask_sent": "TEXT DEFAULT ''", "mail_archive_json": "TEXT DEFAULT '[]'",
